...
export default class InputOutputComponent implements OnDestroy{
  ...
  //INTERVALO PARA AGREGAR PRODUCTOS
  ...
  private intervalSubscription = interval(1000).pipe(
    ...
    take(7) //El TAKE le dice al observable que despues de 7 emisiones se limpie y pare
  ).subscribe(); //este susvribe empieza a ejecutar el codigo porque se suscribe.
